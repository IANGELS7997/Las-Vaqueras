...
export default function TermsPage() {
  const sections = [
    ...
    },
    {
      ...
      content:
        'Los precios de comida corresponden a la carta. En recoger, el envío es $0. En domicilio de 0 a 3000 m y en turno IANGEL (12:00–21:00), el envío es $50. Si el rider está ocupado, el envío sigue en $50 con aviso de 35 a 45 min, sin Uber. De 3001 m a 4000 m el envío es la cotización de Uber Direct menos el 3% de esa cotización. Desde las 21:00, de 0 a 4000 m el envío es Uber Direct (mismo 3%). Más de 4000 m no hay domicilio; puede recoger en tienda. Todos los precios están expresados en pesos mexicanos (MXN). El pago en línea es requisito para que el pedido exista.',
    },
    {
